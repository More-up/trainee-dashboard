const translations = {
    ja: {
        ...
        nationality: '国籍',
        button: 'アンケートを始める',
        privacyTitle: 'あなたの名前は記録されません',
        privacyMessage: '安心して正直に答えてください',
        nationalities: { vn: 'ベトナム', kh: 'カンボジア', in: 'インド', ph: 'フィリピン', la: 'ラオス', mn: 'モンゴル', bd: 'バングラデシュ', lk: 'スリランカ', mm: 'ミャンマー', bt: 'ブータン', uz: 'ウズベキスタン', pk: 'パキスタン', th: 'タイ', id: 'インドネシア', np: 'ネパール', cn: '中国', jp: '日本' },
    ...
    vn: {
        ...
        privacyTitle: 'Tên của bạn sẽ không được ghi lại',
        privacyMessage: 'Hãy trả lời trung thực một cách an tâm',
        nationalities: { vn: 'Việt Nam', kh: 'Campuchia', in: 'Ấn Độ', ph: 'Philippines', la: 'Lào', mn: 'Mông Cổ', bd: 'Bangladesh', lk: 'Sri Lanka', mm: 'Myanmar', bt: 'Bhutan', uz: 'Uzbekistan', pk: 'Pakistan', th: 'Thái Lan', id: 'Indonesia', np: 'Nepal', cn: 'Trung Quốc', jp: 'Nhật Bản' },
    ...
    id: {
        ...
        button: 'Mulai Survei',
        privacyTitle: 'Nama Anda tidak akan dicatat',
        privacyMessage: 'Silakan jawab dengan jujur dengan aman',
        nationalities: { vn: 'Vietnam', kh: 'Kamboja', in: 'India', ph: 'Filipina', la: 'Laos', mn: 'Mongolia', bd: 'Bangladesh', lk: 'Sri Lanka', mm: 'Myanmar', bt: 'Bhutan', uz: 'Uzbekistan', pk: 'Pakistan', th: 'Thailand', id: 'Indonesia', np: 'Nepal', cn: 'Tiongkok', jp: 'Jepang' },
        categories: { workEnvironment: 'Lingkungan Kerja', communication: 'Komunikasi', workLifeBalance: 'Keseimbangan Kerja-Hidup', careerDevelopment: 'Pengembangan Karir', compensation: 'Kompensasi', management: 'Manajemen', diversity: 'Keberagaman dan Inklusi', safety: 'Keselamatan dan Kesehatan' },
        questions: { q1: 'Apakah Anda puas dengan lingkungan kerja?', q2: 'Apakah peralatan dan alat yang diperlukan disediakan dengan cukup?', q3: 'Apakah tempat kerja bersih dan rapi?', q4: 'Apakah waktu istirahat dan ruang istirahat memadai?', q5: 'Apakah komunikasi dengan atasan dan rekan kerja lancar?', q6: 'Apakah instruksi dan penjelasan pekerjaan mudah dipahami?', q7: 'Apakah ada orang yang bisa Anda konsultasikan saat menghadapi kesulitan?', q8: 'Apakah Anda menerima umpan balik secara teratur?', q9: 'Apakah jam kerja sesuai?', q10: 'Apakah lembur tidak berlebihan?', q11: 'Apakah mudah mengambil cuti?', q12: 'Apakah Anda memiliki keseimbangan antara pekerjaan dan kehidupan pribadi?', q13: 'Apakah ada kesempatan untuk promosi dan kenaikan gaji?', q14: 'Apakah disediakan kesempatan pelatihan dan pendidikan?', q15: 'Apakah Anda menerima dukungan pengembangan karir?', q16: 'Apakah ada kesempatan untuk mempelajari keterampilan baru?', q17: 'Apakah gaji sesuai dengan pekerjaan?', q18: 'Apakah Anda puas dengan tunjangan kesejahteraan?', q19: 'Apakah bonus dan tunjangan memadai?', q20: 'Apakah sistem asuransi sosial dan pensiun sudah lengkap?', q21: 'Apakah kebijakan dan tujuan perusahaan jelas?', q22: 'Apakah Anda merasa keputusan manajemen adil?', q23: 'Apakah pendapat dan saran Anda didengarkan?', q24: 'Apakah Anda memiliki harapan untuk masa depan perusahaan?', q25: 'Apakah perbedaan budaya dan bahasa dihormati?', q26: 'Apakah Anda pernah merasakan diskriminasi atau pelecehan?', q27: 'Apakah karyawan dengan latar belakang yang beragam aktif?', q28: 'Apakah Anda merasa menerima penilaian yang adil?', q29: 'Apakah tempat kerja aman?', q30: 'Apakah pendidikan dan pelatihan keselamatan memadai?', q31: 'Apakah penanganan cedera dan kecelakaan memadai?', q32: 'Apakah ada pemeriksaan kesehatan dan dukungan kesehatan mental?', q33: 'Secara keseluruhan, apakah Anda puas bekerja di tempat ini?', q34: 'Apakah Anda ingin merekomendasikan perusahaan ini kepada teman atau keluarga?', q35: 'Jika ada yang ingin Anda perbaiki, silakan tulis dengan bebas (opsional)' },
        choices: { satisfaction: ['Sangat tidak puas', 'Tidak puas', 'Netral', 'Puas', 'Sangat puas'], desire: ['Sangat tidak setuju', 'Tidak setuju', 'Netral', 'Setuju', 'Sangat setuju'], understanding: ['Sangat tidak memahami', 'Tidak terlalu memahami', 'Netral', 'Memahami', 'Sangat memahami'], familiarity: ['Sangat tidak tahu', 'Tidak terlalu tahu', 'Netral', 'Tahu', 'Sangat tahu'], availability: ['Sangat tidak ada', 'Hampir tidak ada', 'Netral', 'Ada', 'Sangat cukup'], negative: ['Sering', 'Kadang-kadang', 'Netral', 'Hampir tidak ada', 'Sangat tidak ada'] },
        errors: { employeeCode: 'Harap masukkan nomor karyawan', nationality: 'Harap pilih kebangsaan' },
        completion: { title: 'Survei Selesai', message: 'Terima kasih atas kerja sama Anda', autoClose: 'Menutup secara otomatis...', remaining: 'Tersisa', seconds: 'detik' },
        footerInfo: 'Waktu yang dibutuhkan: Sekitar 5-10 menit'
    }
};
